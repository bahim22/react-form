                ...
                <Toolbar
                    ...
                    <Box
                        ...
                        <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
                            ...
                            <Button variant='text' color='info' size='small' onClick={() => scrollToSection('map')}>
                                Forms
                            </Button>
                            <Button
                                variant='text'
                    ...
                    <Box sx={{ display: { sm: 'flex', md: 'none' } }}>
                        ...
                        <Drawer anchor='top' open={open} onClose={toggleDrawer(false)}>
                            <Box
                                ...
                                <MenuItem onClick={() => scrollToSection('map')}>Projects</MenuItem>
                                <MenuItem onClick={() => scrollToSection('form')}>Contact</MenuItem>
                            </Box>
                        </Drawer>
                    </Box>
                </Toolbar>
